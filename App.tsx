...
const AppContent: React.FC = () => {
  ...
  useEffect(() => {
      (window as any).deleteNode = (id: string) => {
  ...
  return (
    <div className="w-full h-screen relative bg-gray-100 overflow-hidden">
        ...
        {/* Floating Toolbar */}
        <div 
            className={`absolute top-4 left-1/2 -translate-x-1/2 z-[100] bg-white/90 backdrop-blur shadow-xl rounded-2xl flex items-center gap-1 border border-gray-200 transition-all duration-300 origin-top
            ${projectorMode ? 'scale-125 p-3 mt-4' : 'scale-100 p-2'}`}
        >
